...
8. Open **Settings → Integrations → Google Drive saves**, connect a test account in the system browser, and make a manual backup of disposable test saves. Verify the **Hydra Drive Saves** folder, then restore and compare the bytes.
